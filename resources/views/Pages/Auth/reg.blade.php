        ...
        @csrf 
            ...
            <div class="form-row">
                ...
                <select class="form-control" name="gndr">
                    <option value="0" @if(old('gndr') == 0) selected @endif>Male</option>
                    <option  value="1"  @if(old('gndr') == 1) selected @endif>Female</option>
                    <option  value="2"  @if(old('gndr') == 2) selected @endif>Others</option>
                </select>
                </div>
            </div>
            <div class="form-row">
